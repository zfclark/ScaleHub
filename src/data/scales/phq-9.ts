...
export const phq9: ScaleConfig = {
  ...
  instructions:
    '在过去的 2 周内，您有多少时候受到以下任何问题的困扰？请根据实际情况选择最符合的一项。第 9 题涉及自我伤害的相关想法，如在该题有困扰，请务必关注结果页提供的危机资源。',
  meta: {
    timeMinutes: 3,
  ...
  criticalItems: [
    {
      ...
      message:
        '您在第 9 题中反映了自我伤害相关的想法。请认真对待这些感受：您并不孤单，许多人在经历类似痛苦后得到了好转。建议您立即联系专业的危机干预资源。',
    },
  ],
  license: {
